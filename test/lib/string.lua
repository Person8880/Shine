...
UnitTest:Test( "HexToNumber", function( Assert )
	Assert:Equals( 0xf, string.HexToNumber( "f" ) )
	Assert:Equals( 0xff, string.HexToNumber( "ff" ) )
	Assert:Equals( 0xffffffff, string.HexToNumber( "ffffffff" ) )
	Assert:Equals( 0xffffffffff, string.HexToNumber( "ffffffffff" ) )
	Assert:Equals( 0xffffffffffff, string.HexToNumber( "ffffffffffff" ) )
end )
